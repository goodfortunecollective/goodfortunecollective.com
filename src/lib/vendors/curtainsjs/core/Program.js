	...
	createShader(shaderCode, shaderType) {
		...
		if (!this.renderer.production) {
			if (!this.gl.getShaderParameter(shader, this.gl.COMPILE_STATUS)) {
				...
				const shaderTypeString =
					shaderType === this.gl.VERTEX_SHADER ? 'vertex shader' : 'fragment shader';
				...
				return this.createShader(
					shaderType === this.gl.VERTEX_SHADER ? this.defaultVsCode : this.defaultFsCode,
					shaderType
				);
			}
		}
