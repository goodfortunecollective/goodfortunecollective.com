<script lang="ts">
	...
	const projectGridItemsClasses = [
		...
		'col-span-10 col-start-1 md:col-span-6 md:col-start-2 md:-mt-[16.66%] z-1 text-left md:text-left',
		'col-span-10 col-start-3 md:col-span-6 md:col-start-5 md:mt-[16.66%] z-2 text-left md:text-right',
		'col-span-10 col-start-1 md:col-span-4 md:col-start-2 md:-mt-[4.166%] z-1 text-left md:text-left',
		'col-span-10 col-start-3 md:col-span-4 md:col-start-7 md:mt-0 z-2 text-left md:text-right',
		'col-span-10 col-start-1 md:col-span-7 md:col-start-2 md:-mt-0 z-1 text-left md:text-left'
	];
	...
	const getProjectGridItemClass = (index: number) => {
		if (index === 0) {
			return 'z-1 col-span-10 col-start-1 text-left md:col-span-5 md:col-start-3 md:-mt[16.33%] md:text-left 3xl:mt-0  3xl:col-span-4 3xl:col-start-3';
		} else {
