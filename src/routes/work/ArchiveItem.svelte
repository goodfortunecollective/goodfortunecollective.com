...
>
	<div
		class="absolute inset-0 h-full w-full bg-gradient-to-r from-transparent via-slate-700/25 to-transparent opacity-0 transition-opacity duration-300 ease-in hover:opacity-100"
	/>
	<a
